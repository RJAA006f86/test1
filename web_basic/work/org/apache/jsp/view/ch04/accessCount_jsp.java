...
public final class accessCount_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(group1Count == null&&group2Count == null) {
	...
	group2Count = 0;
      ...
      out.write("</style>\r\n");
      out.write("\t<head>\r\n");
      out.write("\t\t<title>【アクセスカウントページ】</title>\r\n");
      out.write("\t</head>\r\n");
      out.write("\t\t<body>\r\n");
      out.write("\t\t\t<h1 style=\"text-align:center\">アクセスカウントページ</h1>\r\n");
      ...
      out.write("\t\t\t\t<p>【グループ1】");
      out.print(group1Count);
      out.write("人</p>\r\n");
      out.write("\t\t\t\t<p>【グループ2】");
      out.print(group2Count);
      out.write("人</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<p style=\"color:blue;\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/view/ch04/accessCount.jsp\">再読み込み</a></p>\r\n");
      out.write("\t\t\t<p style=\"color:blue;\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/Userctl?countReset=True\">人数カウントリセット</a></p>\r\n");
      out.write("\t\t\t<p style=\"color:blue;\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/Admin\">表示色設定ページ</a></p>\r\n");
      out.write("\t\t</body>\r\n");
      out.write("</html>\r\n");
      out.write("\r\n");
      out.write("\r\n");
